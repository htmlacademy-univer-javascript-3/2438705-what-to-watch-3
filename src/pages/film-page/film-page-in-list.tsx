...
export function FilmPageInList({promoFilm, films}: FilmCardProps): JSX.Element {
  return (
    <>
            ...
            <div className="film-card__desc">
              ...
              <div className="film-rating">
                ...
                <p className="film-rating__meta">
                  ...
                  <span className="film-rating__count">{promoFilm.ratingCount} ratings</span>
                </p>
              </div>
              ...
              <div className="film-card__text">
                ...
                <p className="film-card__starring"><strong>Starring: {promoFilm.starring}</strong>
                </p>
              </div>
            </div>
          </div>
